...
<script>
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            for( x in data.data ){
                $("#instafeed-gallery-feed").append('<li class="instagram-banner-item">' +
                    '<a target="_blank" class="instagram-banner-link" href="'+data.data[x].link+'">'+
...
<div class="content">
    ...
    <ul class="category-menu-list category-menu-list--main">
        ...
        for($a=0; $a<count($menu['arr_menu1_cd']); $a++){
            switch($menu['arr_menu1_cd'][$a]){
                ...
                case "21000000": $icon = 'spr-common ico-category-digital';		break;
                case "22000000": $icon = 'spr-common ico-category-food';	    break;
                case "23000000": $icon = 'spr-common ico-category-beauty';		break;
                case "20000000": break;
                default: $icon = '';
            } ?>
        ...
        <div class="prd-list-wrap">
            <ul class="prd-list prd-list--main owl-carousel owl-dot2">
                <?foreach($etah_choice as $erow){?>
                    ...
                    <li class="prd-bookmark-item"><a href="#layerSnsShare" class="prd-bookmark-link" data-layer="layer-open" onClick="javaScript:openShareLayer('<?/*=$erow['GOODS_CD']*/?>', '<?/*=$erow['IMG_URL']*/?>', '<?/*=$erow['GOODS_NM']*/?>');"><span class="ico-share spr-common"></span><span class="hide">공유하기</span></a></li>
                </ul>-->
                        </div>
                    </li>
                <? }?>
    ...
    <div class="instagram-banner">
        ...
        <div id="instafeed-gallery-feed" class="gallery row no-gutter" style="height: auto !important;"></div>
    </div>
    <!-- INSTAGRAM // -->
    ...
    <div class="layer-wrap layer-main01 layer-wrap--view" id="layerMainPopup" style="visibility:hidden;">
        <div class="layer-inner">
            <div class="layer-content">
                <!-- <a href="#none"><img src="http://ui.etah.co.kr/assets/images/data/main_pop_01_190125.jpg" style="width: 100%;" alt=""></a> -->
                <!-- <a href="/goods/event/66"><img src="http://ui.etah.co.kr/assets/images/data/main_popup02_190208.jpg" style="width: 100%;" alt=""></a> -->
                <a href="/goods/event/66"><img src="http://ui.etah.co.kr/assets/images/data/main_popup02_190415.jpg" style="width: 100%;" alt=""></a>
                <a href="/member/member_join1"><img src="http://ui.etah.co.kr/assets/images/data/main_popup03_190225.jpg" style="width: 100%;" alt=""></a>
            </div>
