<div class="layer layer__use_clause" id="layer__use_clause_1">
	<div class="layer_inner">
		<h1 class="layer_title">서비스 이용약관</h1>
		<div class="layer_cont">
			<ul class="use_clause_list">
				<li>
					<span class="title">제1조(목적)</span>
					<p class="paragraph">이 약관은 (주)에타(전자상거래 사업자)가 운영하는 에타 사이버 몰(이하 “몰“이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스“라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
					<br />
				...
				<li>
					...
					<ul>
						...
						<li>② “몰”은 제1항과 같이 회원으로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 회원으로 등록합니다.<br/>
							...
							&nbsp;&nbsp;&nbsp;3.기타 회원으로 등록하는 것이 “몰”의 기술상 현저히 지장이 있다고 판단되는 경우</li>
				...
				<li>
					...
					<ul>
						...
						<li>② 회원이 다음 각 호의 사유에 해당하는 경우, “몰”은 회원자격을 제한 및 정지시킬 수 있습니다.<br/>
							...
							&nbsp;&nbsp;&nbsp;4.“몰”을 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</li>
				...
				<li>
					...
					<ul>
						<li>① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.<br/>
							&nbsp;&nbsp;&nbsp;1.재화 등의 검색 및 선택<br/>
						...
						<li>③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을 통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li>①  “몰”은 제9조와 같은 구매신청에 대하여 다음 각 호에 해당하면 승낙하지 않을 수 있습니다. 다만, 미성년자와 계약을 체결하는 경우에는 법정대리인의 동의를 얻지 못하면 미성년자 본인 또는 법정대리인이 계약을 취소할 수 있다는 내용을 고지하여야 합니다.<br/>
							&nbsp;&nbsp;&nbsp;1.신청 내용에 허위, 기재누락, 오기가 있는 경우<br/>
							&nbsp;&nbsp;&nbsp;2.미성년자가 담배, 주류 등 청소년보호법에서 금지하는 재화 및 용역을 구매하는 경우<br/>
							&nbsp;&nbsp;&nbsp;3.기타 구매신청에 승낙하는 것이 “몰” 기술상 현저히 지장이 있다고 판단하는 경우</li>
				...
				<li>
					...
					<ul>
						<li>① “몰”과 재화등의 구매에 관한 계약을 체결한 이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」 제13조 제2항에 따른 계약내용에 관한 서면을 받은 날(그 서면을 받은 때보다 재화 등의 공급이 늦게 이루어진 경우에는 재화 등을 공급받거나 재화 등의 공급이 시작된 날을 말합니다)부터 7일 이내에는 청약의 철회를 할 수 있습니다. 다만, 청약철회에 관하여 「전자상거래 등에서의 소비자보호에 관한 법률」에 달리 정함이 있는 경우에는 동 법 규정에 따릅니다.</li>
						<li>② 이용자는 재화 등을 배송 받은 경우 다음 각 호의 1에 해당하는 경우에는 반품 및 교환을 할 수 없습니다.<br/>
							...
							&nbsp;&nbsp;&nbsp;4. 같은 성능을 지닌 재화 등으로 복제가 가능한 경우 그 원본인 재화 등의 포장을 훼손한 경우</li>
				...
				<li>
					<span class="title">제17조(개인정보보호)</span>
					<ul>
				...
				<li>
					<span class="title">제18조(“몰”의 의무)</span>
					<ul>
				...
				<li>
					<span class="title">제19조(회원의 ID 및 비밀번호에 대한 의무)</span>
					<ul>
				...
				<li>
					<span class="title">제20조(이용자의 의무)</span>
				...
				<li>
					<span class="title">제21조(연결“몰”과 피연결“몰” 간의 관계)</span>
					<ul>
				...
				<li>
					<span class="title">제22조(저작권의 귀속 및 이용제한)</span>
					<ul>
				...
				<li>
					<span class="title">제23조(분쟁해결)</span>
					<ul>
				...
				<li>
					<span class="title">제24조(재판권 및 준거법)</span>
					<ul>
				...
				<br/>
				<p>부 칙(시행일) 이 약관은 2016년 7월 4일부터 시행합니다.</p>
			</ul>
		</div>
		<a href="javascript:jsClauseClose('1');" class="spr-common layer_close" title="레이어 닫기"></a>
	</div>
	<div class="dimd"></div>
</div>
...
<!-- 개인정보처리방침 레이어 // -->
<div class="layer layer__use_clause" id="layer__use_clause_2">
	<div class="layer_inner">
		<h1 class="layer_title">개인정보처리방침</h1>
		<div class="layer_cont">
			<h2 class="use_clause_title">(주)에타 개인정보처리방침</h2>
			<ul class="use_clause_list">
				<li>
				...
				<li>
					<span class="title">2. 개인정보 수집, 처리 및 보유</span>
					<p class="paragraph">에타는 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적 이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.</p>
					<ul>
		...
		<a href="javascript:jsClauseClose('2');" class="spr-common layer_close" title="레이어 닫기"></a>
	</div>
	<div class="dimd"></div>
</div>
<!-- // 개인정보처리방침 레이어 -->