<div class="layer layer__use_clause" id="layer__use_clause">
	<div class="layer_inner">
		<h1 class="layer_title">서비스 이용약관</h1>
		<div class="layer_cont">
			<ul class="use_clause_list">
				<li>
					<span class="title">㈜에타 개인정보처리방침</span>
		...
		<a href="javascript:jsClauseClose();" class="spr-common layer_close" title="레이어 닫기"></a>
	</div>
	<div class="dimd"></div>
</div>