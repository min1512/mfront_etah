					...
					<td style="border-bottom: 1px solid #eee; height: 59px;">
						<table width="780" border="0" cellspacing="0" cellpadding="0">
							<tbody>
								...
								<tr>
									<td style="font-size: 30px; color:#000;text-align: center;">회원가입을 축하드립니다!</td>
								</tr>
								<tr>
									<td height="12"></td>
								</tr>
								<tr>
									<td style="color:#999;font-size:14px;text-align: center;"><em style="color: #000; font-style:normal;">{{mem_name}}</em> 님의 신규 가입을 진심으로 축하드립니다.</td>
								</tr>
								<tr>
									<td height="15"></td>
								</tr>
								...
								<tr>
									<td style="color:#999;font-size:14px;text-align: center;"><em style="color: #000; font-style:normal;">{{mem_name}}</em> 님이 에타몰에 가입하신 등록 정보입니다.</td>
								</tr>
								<tr>
									<td height="29"></td>
								</tr>
								<tr>
									<td>
										<table width="567" border="0" cellspacing="0" cellpadding="0" style=" margin: 0 auto; border:1px solid #eee; background:#f6f6f6;">
											<tbody>
												<tr>
													<td height="58" style="color: #000;font-size:12px;text-align: center;">회원아이디<span style="padding: 0 13px;">:</span>{{mem_id}}</td>
												</tr>
											</tbody>
										</table>
									</td>
								...
								<tr>
									<td height="56" style="color: #999; font-size: 12px;text-align:center;">※ 회원정보 변경이 필요하신 경우 회원정보수정에서 수정이 가능합니다.</td>
								</tr>
								...
								<tr>
									<td height="56">
										<div style="width:159px;height:50px;text-align:center;margin: 0 auto;"><a href="<?=base_url()?>member/login?return_url=/mywiz/myinfo" style="display:block;padding:16px 0;text-align:center;color:#fff;font-size:14px;background:#000;text-decoration:none;">회원정보 수정</a></div>
									</td>
								</tr>
								<tr>
									<td height="77"></td>
