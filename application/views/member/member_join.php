<link rel="stylesheet" href="/assets/css/member.css?ver=1.0">
<div class="content">
    <h2 class="page-title-basic page-title-basic--line">MEMBERSHIP</h2>
    <div class="join-content-wrap">
        <h3 class="info-title info-title--sub">필수항목</h3>

        <form method="post" id="memForm" name="memForm" action="">
            <input type="hidden" id="chkId" name="chkId" value="" />
            <input type="hidden" id="chk_rcmdId" name="chk_rcmdId" value="" />
            ...
            <div class="join-form">
                <div class="form-line form-line--wide form-line--cols">
                    <div class="form-line form-line--wide form-line--cols">
                        <div class="form-line-title"><label for="joinPhoneForm1_1"></label></div>
                        <div class="form-line-info">
                            <div class="form-line--cols-item">
                                <div class="select-box select-box--big">
                                    <select class="select-box-inner" id="joinPhoneForm1_1" name="mem_mobile1">
                            ...
                            <div class="form-line--cols-item">
                                <label for="joinPhoneForm1_2"><input type="tel" class="input-text" id="joinPhoneForm1_2" name="mem_mobile2" style="ime-mode:disabled;" maxlength="4" onkeyup="CheckNum(this);"></label>
                            </div>
                            <span class="dash">-</span>
                            <div class="form-line--cols-item">
                                <label for="joinPhoneForm1_3"><input type="tel" class="input-text" id="joinPhoneForm1_3" name="mem_mobile3" style="ime-mode:disabled;" maxlength="4" onkeyup="CheckNum(this);"></label>
                            </div>&nbsp;&nbsp;
                            <a href="#" onClick="SendPhoneAuth();"  class="btn-gray btn-email" id="auth_button2">인증하기</a>
                        </div>
                    </div>
                </div>
                <div class="form-line form-line--modify">
                    <div class="form-line-info form-line-info--check">
                        <label class="form-line-title" for="joinPhoneForm1_2">인증번호</label>
                        <input type="text" id="joinPhoneForm2_1" name="mem_auth" class="input-text input-text-join-info input-text--modify">
                        <a id="auth_button" href="javascript://" onClick="CheckPhone();" class="btn-white btn-white--bold">인증확인</a>
                    </div>
                </div>

                <div class="form-line form-line--modify">
                    <div class="form-line-info form-line-info--check">
                        <label class="form-line-title" for="joinIdForm">아이디</label>
                        <input type="text" id="joinIdForm" name="mem_id" onkeyup="this.value=this.value.replace(/\s/g,'')" maxlength="30" class="input-text input-text-join-info">
                        <a name="chkIdBtn" href="javascript://" onClick="CheckID('4', '11');" class="btn-white btn-white--bold">중복확인</a>
                    </div>
                </div>
                <div class="form-line form-line--modify">
                    <div class="form-line-info">
                        <label class="form-line-title" for="joinPwdForm1_1">비밀번호</label>
                        <input type="password" class="input-text" id="joinPwdForm1_1" name="mem_password" value="" onkeyup="this.value=this.value.replace(/\s/g,'')" maxlength="30" placeholder="공백없는 8~16자 영문/숫자 조합">
                    </div>
                </div>
                <div class="form-line form-line--modify">
                    <div class="form-line-info">
                        <label for="joinPwdForm1_2" class="form-line-title">비밀번호확인</label>
                        <input type="password" class="input-text input-text--modify" id="joinPwdForm1_2" placeholder="비밀번호 확인을 위해 다시 입력해주세요." name="mem_repassword" value="" onkeyup="this.value=this.value.replace(/\s/g,'')" maxlength="30">
                    </div>
                </div>
                <div class="form-line form-line--modify">
                    <div class="form-line-info">
                        <label class="form-line-title" for="joinNameForm">이름</label>
                        <input type="text" class="input-text" id="joinNameForm" name="mem_name" maxlength="30" placeholder="한글 15자, 영문 30자까지 입력 가능">
                    </div>
                </div>

                <div class="form-line form-line--wide form-line--cols">
                    <div class="form-line-info form-line-info--email">
                        <div class="form-line--cols-item">
                            <label><input type="text" name="mem_email1" class="input-text" placeholder="이메일"></label>
                        </div>
                        <span class="dash">@</span>
                        <input type="hidden" id="formJoin05_2" name="mem_email2"  value=""/>
                        <div class="form-line--cols-item input-text-join-info">
                            <div class="select-box select-box--big">
                                <label for="emailAddressSelect">이메일주소선택</label>
                                <select class="select-box-inner" id="emailAddressSelect" data-ui="select-val" onChange="javascript:$('input[name=mem_email2]').val(this.value);">
                                ...
                                <span class="email-address-input" style="display:none;"><input type="text" class="input-text" id="emailAddressInput" onChange="javascript:emailoption();"></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="agree-check-area">
                <div class="join-info-all-check">
                    <input type="checkbox" id="joincheckAgree0" class="checkbox" onClick="javascript:jsChkAll(this.checked);">
                    <label for="joincheckAgree0" class="checkbox-label">약관 전체동의</label>
                </div>

                <ul class="check-text-list">
                    <li class="check-text-item">
                        <input type="checkbox" id="formAgree00" name="formAgree[]" class="checkbox" checked>
                        <label for="formAgree00" class="checkbox-label">만 14세 이상입니다.</label>
                    </li>
                    <li class="check-text-item check-text-item--modify">
                        <input type="checkbox" id="formAgree01" name="formAgree[]" class="checkbox">
                        <label for="formAgree01" class="checkbox-label">이용약관에 동의 합니다.</label>
                        <a href="#layerAgreeUtil" class="btn-all-view-link" data-layer="bottom-layer-open2">내용확인</a>
                    </li>
                    <li class="check-text-item">
                        <input type="checkbox" id="formAgree02" name="formAgree[]" class="checkbox">
                        <label for="formAgree02" class="checkbox-label">개인정보 수집 및 이용에 동의 합니다.</label>
                        <a href="#layerPersonalInfoAgree" class="btn-all-view-link" data-layer="bottom-layer-open2">내용확인</a>
                    </li>
                </ul>
            </div>
            <h3 class="info-title info-title--sub">선택항목</h3>
            <span class="red-text">선택항목을 입력하시면 1,000점이 즉시 적립됩니다.</span>
            <div class="choice-list-area">
                <div class="form-line form-line--modify">
                    <div class="form-line-info">
                        <label for="joinDateForm" class="form-line-title">생년월일</label>
                        <input type="text" class="input-text" id="joinDateForm"  name="mem_birth" placeholder="YYYYMMDD">
                    </div>
                </div>
                <div class="form-line form-line--modify">
                    ...
                    <div class="form-line-info option-area">
                        <label class="common-radio-label" for="joinGenderCheck1">
                            <input type="radio" id="joinGenderCheck1" class="common-radio-btn" name="mem_gender" value="MALE">
                            <span class="common-radio-text">남자</span>
                        </label>
                        <label class="common-radio-label" for="joinGenderCheck2">
                            <input type="radio" id="joinGenderCheck2" class="common-radio-btn" name="mem_gender" value="FEMALE">
                ...
                <div class="form-line form-line--modify">
                    ...
                    <div class="form-line-info option-area">
                        <label class="common-radio-label" for="joinPetCheck1">
                            <input type="radio" id="joinPetCheck1" class="common-radio-btn" name="petYn" value="Y">
                            <span class="common-radio-text">있음</span>
                        </label>
                        <label class="common-radio-label" for="joinPetCheck2">
                            <input type="radio" id="joinPetCheck2" class="common-radio-btn" name="petYn" value="N">
                ...
                <div class="form-line form-line--modify">
                    ...
                    <div class="form-line-info option-area">
                        <label class="common-radio-label" for="joinMarriageCheck1">
                            <input type="radio" id="joinMarriageCheck1" class="common-radio-btn" name="merry" value="Y">
                            <span class="common-radio-text">예</span>
                        </label>
                        <label class="common-radio-label" for="joinMarriageCheck2">
                            <input type="radio" id="joinMarriageCheck2" class="common-radio-btn" name="merry" value="N">
                ...
                <div class="form-line form-line--modify">
                    ...
                    <div class="form-line-info option-area">
                        <ul class="text-list">
                            <li class="text-item">추천인 ID를 입력하시고 첫 구매 완료시 마일리지 5,000점을 드립니다!</li>
                        </ul>
                        <div class="form-line-info form-line-info--check">
                            <input type="text" id="rcmdID" class="input-text input-text-join-info input-text--modify" value="" style="width: 142px; padding-left:0.625rem;" name="rcmdID">
                            <button type="button" class="btn-gray" style="width: 70px;" onclick="jsRecommendId($('#rcmdID').val())">ID 확인</button>
                        </div>
                    </div>
                </div>
            </div>

            <div class="agree-info-area">
                <ul class="text-list">
                    <li class="text-item">주문 및 배송관련 정보는 수신동의와 상관없이 자동 발송되며, <br>
                        수신동의를 하게되시면 에타에서 제공하는 유용한 쇼핑정보(이벤트/할인쿠폰/기획전)소식을 받으실 수 있습니다.</li>
                </ul>
                <div class="form-line-info agree-info-area agree-info-area--modify">
                    <label class="common-radio-label" for="joinInfoCheck1">
                        <input type="radio" id="joinInfoCheck1" name="Agree_yn" class="common-radio-btn" value="Y" checked>
                        <span class="common-radio-text">동의</span>
                    </label>
                    <label class="common-radio-label" for="joinInfoCheck2">
                        <input type="radio" id="joinInfoCheck2" name="Agree_yn" class="common-radio-btn" value="N">
            ...
            <ul class="common-btn-box">
                <li class="common-btn-item"><a href="javascript:location.href = '/';" class="btn-white btn-white--big">가입취소</a></li>
                <li class="common-btn-item"><a href="javascript://" onClick="jsJoin();" class="btn-black btn-black--big">회원가입</a></li>
            </ul>
    </div>

    <!-- 이용약관 동의 레이어 // -->
    <div class="common-layer-wrap layer-agree-util" id="layerAgreeUtil">
        <h3 class="common-layer-title">서비스 이용약관</h3>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li class="use-clause-item">③ “몰”이 제3자에게 구매자의 개인정보를 취급할 수 있도록 업무를 위탁하는 경우에는 1) 개인정보 취급위탁을 받는 자, 2) 개인정보 취급위탁을 하는 업무의 내용을 구매자에게 알리고 동의를 받아야 합니다. (동의를 받은 사항이 변경되는 경우에도 같습니다.) 다만, 서비스제공에 관한 계약이행을 위해 필요하고 구매자의 편의증진과 관련된 경우에는 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」에서 정하고 있는 방법으로 개인정보 취급방침을
                            통해 알림으로써 고지절차와 동의절차를 거치지 않아도 됩니다.</li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul>
                        <li class="use-clause-item">① “몰”은 이용자와 재화 등의 공급시기에 관하여 별도의 약정이 없는 이상, 이용자가 청약을 한 날부터 7일 이내에 재화 등을 배송할 수 있도록 주문제작, 포장 등 기타의 필요한 조치를 취합니다. 다만, “몰”이 이미 재화 등의 대금의 전부 또는 일부를 받은 경우에는 대금의 전부 또는 일부를 받은 날부터 3영업일 이내에 조치를 취합니다. 이때 “몰”은 이용자가 재화 등의 공급 절차 및 진행 사항을 확인할 수 있도록 적절한조치를 합니다.</li>
...
<script type="text/javascript">
    ...
    // 아이디 중복 체크
    //===============================================================
    function CheckID(minSize, maxSize)
    {
        var SSL_val = "<?=$_SERVER['HTTP_HOST']?>";

        var smallAlpha_Num =/^[a-zA-Z0-9]+$/;
        var mem_id = $("input[name=mem_id]").val();

        if (mem_id == "") {
            alert("회원 ID를 입력하지 않았습니다.");
            $("input[name=mem_id]").focus();
            return false;
        }
        if (! smallAlpha_Num.test(mem_id)) {
            alert("아이디(ID) 항목은 영문자, 숫자만 입력하실수 있습니다.");
            $("input[name=mem_id]").focus();
            return false;
        }
        if (minSize > mem_id.length) {
            alert("아이디(ID) 항목은 4자 이상이어야 합니다.");
            $("input[name=mem_id]").focus();
            return false;
        }
        if (maxSize < mem_id.length) {
            alert("아이디(ID) 항목은 11자 이하이어야 합니다.");
            $("input[name=mem_id]").focus();
            return false;
        }
        ...
        $.ajax({
            type: 'POST',
            url: 'https://'+SSL_val+'/member/id_check',
            dataType: 'json',
            data: { 'mem_id' : mem_id },
            error: function(res) {
            ...
            success: function(res) {
                if(res.status == 'ok'){
                    $('input[name=chkId]').val(res.mem_id);
                    $("input[name=mem_password]").select();
                    alert("사용 가능한 아이디입니다.");
                    $("input[name=mem_password]").focus();
                }
                else {
                    alert(res.message);
                    $("input[name=mem_id]").focus();
    ...
    function SendPhoneAuth()
    {
        ...
        var SSL_val = "<?=$_SERVER['HTTP_HOST']?>";
        var mem_mobile = $("select[name=mem_mobile1]").val()+'-'+$("input[name=mem_mobile2]").val()+'-'+$("input[name=mem_mobile3]").val();

        if(memForm.mem_mobile2.value == ""){
            alert("휴대폰번호를 입력해주세요.");
            memForm.mem_mobile2.focus();
            return false;
        }
        if(memForm.mem_mobile3.value == ""){
            alert("휴대폰번호를 입력해주세요.");
            memForm.mem_mobile3.focus();
            return false;
        }

        if(memForm.mem_mobile2.value.length != 3 && memForm.mem_mobile2.value.length != 4){
            alert("휴대폰번호의 형식에 맞지 않습니다.");
            memForm.mem_mobile2.focus();
            return false;
        }

        if(memForm.mem_mobile3.value.length != 4){
            alert("휴대폰번호의 형식에 맞지 않습니다.");
            memForm.mem_mobile3.focus();
            return false;
        }
            ...
            $.ajax({
                ...
                success: function(res) {
                    if(res.status == 'ok'){
                        ...
                        //인증확인되면 휴대전화 관련 항목 비활성화
                        document.getElementById("joinPhoneForm1_1").disabled = true;
                        document.getElementById("joinPhoneForm1_2").disabled = true;
                        document.getElementById("joinPhoneForm1_3").disabled = true;
                        document.getElementById("joinPhoneForm2_1").disabled = true;
                        $("#auth_button").removeAttr("onclick");
                        $("#auth_button2").removeAttr("onclick");
    ...
    function jsCheck()
    {
        var PWCheck1 = /^[a-zA-Z0-9]+$/;
        var PWCheck2 = /[a-zA-Z]/g;
        var PWCheck3 = /[0-9]/g;
        ...
        if(memForm.chk_auth.value != 'Y'){
            alert("휴대폰 인증을 하셔야 합니다.");
            memForm.mem_auth.focus();
            return false;
        }
        if(memForm.mem_id.value == ""){
            alert("회원 ID를 입력하지 않았습니다.");
            memForm.mem_id.focus();
            return false;
        }
        if(memForm.chkId.value == ""){
            alert("아이디 중복확인을 하셔야 합니다.");
            memForm.chkIdBtn.focus();
            return false;
        }
        if(memForm.mem_password.value == ""){
            alert("비밀번호를 입력하지 않았습니다.");
            memForm.mem_password.focus();
            return false;
        }
        if(memForm.mem_repassword.value == ""){
            alert("비밀번호 확인을 입력하지 않았습니다.");
            memForm.mem_repassword.focus();
            return false;
        }
        if(memForm.mem_password.value != memForm.mem_repassword.value){
            alert("비밀번호와 비밀번호 확인이 다릅니다.");
            memForm.mem_repassword.value = "";
            memForm.mem_repassword.focus();
            return false;
        }
        if(memForm.mem_password.value.length < 8 || memForm.mem_password.value.length > 16 ){
            alert("비밀번호는 8자리 이상 16자리 이하를 입력하셔야 합니다.");
            memForm.mem_password.focus();
            return false;
        }
        if (( PWCheck1.test(memForm.mem_password.value) && PWCheck2.test(memForm.mem_password.value) && PWCheck3.test(memForm.mem_password.value) ) == false) {
            alert("비밀번호는 영문과 숫자를 조합하여 생성해주세요.");
            memForm.mem_password.focus();
            return false;
        }
        if(memForm.mem_name.value == ""){
            alert("이름을 입력해주세요.");
            memForm.mem_name.focus();
            return false;
        }
        if(memForm.mem_email1.value == ""){
            alert("이메일을 입력해주세요.");
            memForm.mem_email.focus();
            return false;
        }

        if(emailReg.test('pipi0824@naver.com') == false){
            alert("이메일의 형식이 아닙니다.");
            memForm.mem_email.focus();
            return false;
        }

        if($("input:checkbox[id='formAgree00']").is(":checked") == false || $("input:checkbox[id='formAgree01']").is(":checked") == false || $("input:checkbox[id='formAgree02']").is(":checked") == false){
            alert("ETAH 회원가입을 위해 필수 동의항목 모두 체크해주시기 바랍니다.");
            return false;
        }

        if(memForm.mem_birth.value != '' && memForm.mem_birth.value.length != 8){
            alert("생년월일의 형식이 맞지 않습니다.");
            memForm.mem_birth.focus();
            return false;
        }

        if(memForm.rcmdID.value != "" && memForm.chk_rcmdId.value == ""){
            alert("추천인 ID 확인을 해주셔야 합니다.");
            memForm.rcmdID.focus();
            return false;
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                if(res.status == 'ok'){
                    ...
                    f.action = "https://"+SSL_val+"/member/join_finish";
                    f.submit();
                }
                else {
                    alert(res.message);
    ...
    {
        if($("#emailAddressSelect").val() == '직접입력'){
            var  email = $("#emailAddressInput").val();
        }
        $('input[name=mem_email2]').val(email);
    }
